        ...
        <div class="form-group">
            <div class="col-md-6">
                <select required class="form-control selectpicker" name="team">
                    <option @if(isset($clients)) selected @endif disabled="">-- Select Team --</option>
                    @foreach($teams as $u)
                        <option
                                @if(isset($client))
                                @if($client->team_id == $u->id)
                                selected
                                @endif
                                @endif
            ...
            <div class="col-md-6">
                <input type="text" class="form-control input-text-modal" placeholder="Client Name" name="client_name"
                       id="client_name" value="{{ old('client_name', $client->name ?? '') }}">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="text" class="form-control input-text-modal" name="contact_name"
                               id="contact_name" placeholder="Name"
                               value="{{ old('contact_name', $client->contactname ?? '') }}">
                    </div>
                    ...
                    <div class="row" style="margin-bottom: 10px;">
                        <div class="col-md-6">
                            <input type="text" class="form-control input-text-modal"
                                   ...
                                   value="{{ old('contact_phonenumber', $client->contactnumber ?? '') }}">
                        </div>
                        <div class="col-md-6">
                            <input type="text" class="form-control input-text-modal"
                                   name="contact_email" id="contact_email" placeholder="Email"
                                   value="{{ old('contact_email', $client->contactemail ?? '') }}">
                        </div>
                    </div>
                </div>
            </section>
