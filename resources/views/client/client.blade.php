                            ...
                            <section id="Links" class="tab-panel">
                                <div class="row" style="margin-bottom: 10px;">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control input-text-modal" name="link-url"
                                               id="link-url" placeholder="http://">
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label-modal">Title</label>
                                        <input type="text" class="form-control input-text-modal" name="link-title"
                            ...
                            <section id="Contact_person" class="tab-panel">
                                <div class="form-group">
                                    ...
                                    <div class="row" style="margin-bottom: 10px;">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" class="form-control input-text-modal"
                                                   name="contact_surname" id="contact_surname" placeholder="Surname">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row" style="margin-bottom: 10px;">
                                        <div class="col-md-12">
                                            <input type="text" class="form-control input-text-modal"
                                                   name="contact_job-title" id="contact_job-title"
