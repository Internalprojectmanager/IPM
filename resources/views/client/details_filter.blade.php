        ...
        <table class="table table-hover table-center results" id="release-overview">
            ...
            @foreach($projects as $project)
                <tr>
                    ...
                    <td><span id="tabletitle"><a href="{{route('projectdetails', [ $project->path])}}">{{$project->name}}</a></span> <br> <span class="tablesubtitle">@if(isset($project->company)){{$project->company->name}}@endif</span></td>
