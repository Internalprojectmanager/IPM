...
@section('content')
    ...
    <div class="row center">
            <div class="header-3">
                ...
                <svg id="user-icon" width="15px" height="15px" viewBox="0 0 15 15" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                ...
                <svg id="phone-icon" width="15px" height="15px" viewBox="0 0 15 15" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    <!-- Generator: Sketch 47.1 (45422) - http://www.bohemiancoding.com/sketch -->
                ...
                <svg id="world-icon" width="14px" height="14px" viewBox="0 0 14 14" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    <!-- Generator: Sketch 47.1 (45422) - http://www.bohemiancoding.com/sketch -->
                    <title>World icon</title>
                    <desc>Created with Sketch.</desc>
                    <defs></defs>
                    <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        <g id="Project-MUSK-Empty" transform="translate(-982.000000, -202.000000)" fill-rule="nonzero" fill="#666666">
                            <g id="Project-Leeg" transform="translate(140.000000, 143.000000)">
                ...
                <svg id="t-icon" width="12px" height="14px" viewBox="0 0 12 14" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    <!-- Generator: Sketch 47.1 (45422) - http://www.bohemiancoding.com/sketch -->
                    <title>T Copy</title>
                    <desc>Created with Sketch.</desc>
                    <defs></defs>
    ...
    <div class="row center">
        <div class="col-md-4">
            <div class="row">
                <a class="btn btn-primary" id="addrelease" href="{{route('addrelease', ['name' => $projects->name, 'company_id' => $projects->company_id])}}">
