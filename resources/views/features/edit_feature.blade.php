<div class="modal modal-lg" id="editFeatureModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle"
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <form
                action="{{route('updateFeature', ['name' => $feature->releases->projects->path, 'company_id' => $feature->releases->projects->company->path, 'release_name' => $feature->releases->path, 'feature_id' => $feature->id])}}"
                method="post">
                {{ csrf_field() }}
