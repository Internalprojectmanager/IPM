        ...
        <div class="modal-body">
            ...
            <form action="{{route('storefeature', ['name' => $project->name, 'company_id' => $project->company_id, 'release_name' => $release->name])}}" method="post">
                ...
                <div id="featurereq" class="tabset" role="tablist">
                    <!-- Tab 1 -->
                    <input type="radio" class="fr-tabs tab" name="tabsetreq" id="tab1" aria-controls="req1" checked>
                    <label id="tablabel1" class="non-cursive" for="tab1">Requirement 1</label>
                    <i id="more-fr"></i>
                    <!-- Tab 2 -->
                    <input type="radio" class="btn-primary tab" name="tabsetreq" id="newreq">
                    <label for="newreq" class="black">
                        Add more Requirements <span class="icon-right glyphicon glyphicon-plus"></span>
                    </label>
                    <hr class="tab-hr">

                    <div class="tab-panels">
                        <div class="hidden" id="feature-full">
                            <div class="alert alert-danger">
                        ...
                        <section id="req1" class="tab-panel">
