<div class="modal modal-lg" id="addFeatureModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle"
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <form
                action="{{route('storefeature', [ $project->path, $release->path])}}"
                method="post">
                {{ csrf_field() }}
                ...
                <div class="form-group">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control input-text-modal" name="feature_name" required id="feature_name">
                    ...
                    <div class="form-group">
                        ...
                        <select name="feature_status" class="form-control input-text-modal" required>
                            @foreach($status as $s)
