<div class="modal modal-lg" id="addScopeModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle"
     aria-hidden="true">
    <div class="modal-content">
        <div class="modal-header">
            <label>Add Out of scope (scope)</label>
        ...
        <div class="modal-body">
            ...
            <form action="{{route('storefeature', ['name' => $project->path, 'company_id' => $project->company->path, 'release_name' => $release->path])}}" method="post">
                {{ csrf_field() }}
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="description">Out of Scope Description:</label>
