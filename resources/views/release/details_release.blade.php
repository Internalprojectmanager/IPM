    ...
    <div class="row" onload="">
        <div class="header-3" id="project-details">
            <div class="row" id="block-show">
                    ...
                    <div class="col-md-2 col-xs-6">
                        <span class="project-title block-title">Release Status</span> <br>
                        <span class="project-detail block-value">{{$release->rstatus->name}}</span>
                    </div>
                    <div class="col-md-2 col-xs-6">
                        <span class="project-title block-title">Release Deadline</span> <br>
                        <span class="project-detail block-value">
                            @if(isset($release->deadline))
                                {{date("d F Y", strtotime($release->deadline))}}
                            @endif
                            </span>
                    </div>
