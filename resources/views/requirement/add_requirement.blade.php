<div class="modal modal-lg" id="addRequirement" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle"
     aria-hidden="true">
        ...
        <div class="modal-footer row" style="border:none;">
            ...
            <div class="col-md-6" align="right">
                <button class="btn btn-primary" type="submit">
                    Save Requirement <span class="glyphicon glyphicon-plus"></span>
                </button>
            </div>
