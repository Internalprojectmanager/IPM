...
<a href="{{route('home')}}">
    <svg style="margin: 12px 0px 12px 0px;" width="40px" height="46px" viewBox="0 0 40 46" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        ...
        <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            <g id="Project-Overview" transform="translate(-35.000000, -12.000000)" fill-rule="nonzero" fill="#FFFFFF">
                <g id="Left-Side-menu">
...
<a href="{{route('overviewproject')}}" class="sidebar_link">
    <div class="sidebar_object <?php $sUrl = $_SERVER['REQUEST_URI']; $sUrl = substr($sUrl, 1, 7); if ($sUrl == 'project') {echo 'active';} ?>">
        <svg width="32px" height="30px" viewBox="0 0 32 30" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                <g id="Project-Overview" transform="translate(-39.000000, -90.000000)" fill-rule="nonzero" fill="#FFFFFF">
                    <g id="Breadcrumb">
                        <g id="Left-Side-menu">
...
<a href="{{route('overviewclient')}}" class="sidebar_link">
    <div class="sidebar_object <?php $sUrl = $_SERVER['REQUEST_URI']; $sUrl = substr($sUrl, 1, 6); if ($sUrl == 'client') {echo 'active';} ?>">
